...
type PersistedRun=Pick<Run,'id'|'repositoryUrl'|'status'|'mode'|'approvalStatus'|'createdAt'|'updatedAt'|'failureReason'|'fallbackReason'|'trueForgeSessionId'|'trueForgeTurnId'|'events'|'candidates'|'usages'|'before'> & {policy?:unknown};
