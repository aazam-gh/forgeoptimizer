...
export interface Candidate {
  ...
  removesAi: boolean;
  changeType?: "code" | "model" | "prompt" | "dependency" | "ai_removal";
...
export interface ValidationSnapshot {
  state: "PASS" | "FAIL" | "NOT_VERIFIED";
  canPublish: boolean;
  checks: Record<string, "PASS" | "FAIL" | "NOT_VERIFIED">;
  reasons: string[];
}
...
export interface OptimizationScenario {
  ...
  category: "test" | "integration" | "api" | "cli" | "workflow";
  requiredEnv: string[];
}
export interface ScenarioExecutionResult {
  scenarioId: string;
  status: "passed" | "failed" | "timed_out" | "not_verified";
  exitStatus?: number;
  stdout?: string;
  stderr?: string;
  durationMs?: number;
  quality: "MEASURED" | "NOT_VERIFIED";
...
export interface BaselineProfile {
  ...
  latencyMs: number;
  outputs: unknown[];
  quality: "MEASURED" | "ESTIMATED" | "NOT_VERIFIED";
}
export interface EvaluationCase {
  ...
  tolerance?: number;
  source: "existing_test" | "fixture" | "generated";
}
...
export interface OptimizationPlanStep {
  ...
  status: "queued" | "running" | "passed" | "reverted" | "skipped";
}
...
export interface PullRequestRecord {
  ...
  url?: string;
  title: string;
  status: "not_created" | "awaiting_approval" | "created" | "merged";
  branch: GitBranchRecord;
}
export interface ScoringWeights {
  maxFrequencyWeight: number;
  minimumFrequencyWeight: number;
  maximumCoverageWeight: number;
  minimumCoverageWeight: number;
  maximumBlastRadiusPenalty: number;
  minimumBlastRadiusWeight: number;
  estimatedQualityWeight: number;
  inferredQualityWeight: number;
