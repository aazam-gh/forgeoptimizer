...
const transitions:Record<RunStatus,RunStatus[]>={
  idle:['created'],created:['preparing','cancelled'],preparing:['analyzing','ready','failed','cancelled'],analyzing:['baseline_running','planning','ready','fallback','failed','cancelled'],baseline_running:['planning','fallback','failed','cancelled'],planning:['optimizing','validating','failed','cancelled'],optimizing:['validating','reviewing','awaiting_approval','fallback','failed','cancelled'],validating:['reviewing','awaiting_approval','fallback','failed','cancelled'],reviewing:['awaiting_approval','fallback','failed','cancelled'],awaiting_approval:['publishing','cancelled'],publishing:['completed','failed'],fallback:['completed','failed','cancelled'],ready:['planning','optimizing','cancelled'],complete:['awaiting_approval','completed'],completed:[],failed:[],cancelled:[]
};
